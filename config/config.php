<?php
  ...
  define('DB_NAME', 'ngsmusic'); // database name
  ...
  define('PROOT', '/ngs/'); // set this to '/' for a live server.
  ...
  define('SITE_TITLE', 'Ngs Music'); // This will be used if no site title is set
  define('MENU_BRAND', 'HGS'); //This is the Brand text in the menu
